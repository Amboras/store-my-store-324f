...
export const metadata: Metadata = {
  title: {
    default: 'Thread & Form — Premium Shirts',
    template: '%s | Thread & Form',
  },
  description: 'Premium shirts designed to last. Crafted from the finest fabrics for modern men and women who value quality and style.',
}
